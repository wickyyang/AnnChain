...
func NewSecure(root ethcmn.Hash, db Database, cachelimit uint16) (*SecureTrie, error) {
	if db == nil {
...
func (t *SecureTrie) TryUpdate(key, value []byte) error {
	...
	t.getSecKeyCache()[string(hk)] = ethcmn.CopyBytes(key)
	return nil
}
...
// from the database.
func (t *SecureTrie) Commit() (root ethcmn.Hash, err error) {
	return t.CommitTo(t.trie.db)
}

func (t *SecureTrie) Hash() ethcmn.Hash {
	return t.trie.Hash()
}
...
func (t *SecureTrie) CommitTo(db DatabaseWriter) (root ethcmn.Hash, err error) {
