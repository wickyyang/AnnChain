...
import (
	...
	"github.com/dappledger/AnnChain/modules/crypto/sha3"
	"github.com/dappledger/AnnChain/modules/logger"
	"github.com/dappledger/AnnChain/modules/logger/glog"
...
func New(root ethcmn.Hash, db Database) (*Trie, error) {
	trie := &Trie{db: db, originalRoot: root}
	if (root != ethcmn.Hash{}) && root != emptyRoot {
		if db == nil {
...
func (t *Trie) Hash() ethcmn.Hash {
	...
	t.root = cached
	return ethcmn.BytesToHash(hash.(hashNode))
}
...
func (t *Trie) Commit() (root ethcmn.Hash, err error) {
	if t.db == nil {
...
func (t *Trie) CommitTo(db DatabaseWriter) (root ethcmn.Hash, err error) {
	...
	t.root = cached
	t.cachegen++
	return ethcmn.BytesToHash(hash.(hashNode)), nil
}
