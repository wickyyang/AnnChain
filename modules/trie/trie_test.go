...
func TestMissingRoot(t *testing.T) {
	db, _ := db.NewMemDatabase()
	trie, err := New(ethcmn.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), db)
	if trie != nil {
...
func TestMissingNode(t *testing.T) {
	...
	db.Delete(ethcmn.FromHex("e1d943cc8f061a0c0b98162830b970395ac9315654824bf21b73b891365262f9"))
...
func TestInsert(t *testing.T) {
	...
	exp := ethcmn.HexToHash("8aad789dff2f538bca5d8ea56e8abe10f4c7ba3a5dea95fea4cd6e7c3a1168d3")
	root := trie.Hash()
	if root != exp {
	...
	exp = ethcmn.HexToHash("d23786fb4a010da3ce639d66d5e904a11dbc02746d1ce25029e53290cabf28ab")
...
func TestDelete(t *testing.T) {
	...
	hash := trie.Hash()
	exp := ethcmn.HexToHash("5991bb8c6514148a29db676a14ac506cd2cd5775ace63c30a4fe457715e9ac84")
	if hash != exp {
...
func tempDB() (string, Database) {
	...
	db, err := db.NewLDBDatabase(dir, 256, 0)
	if err != nil {
